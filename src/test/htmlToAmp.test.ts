...
describe('Convert Image to <amp-img>', () => {
	test.each([
		[
			'<img src="https://picsum.photos/id/59/200/100" />',
			'<div style="width: 100vw; margin: 0 calc(50% - 50vw);"><amp-img src="https://picsum.photos/id/59/200/100" layout="responsive" width="200" height="100"></amp-img></div>',
		],
		[
